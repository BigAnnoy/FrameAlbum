...
document.addEventListener('DOMContentLoaded', () => {
    // 如果仍未准备，再次检查
    if (!pywebviewReady.isReady && window.pywebview && window.pywebview.api) {
...
// 暴露到全局，保持向后兼容
window.pywebviewReady = pywebviewReady;